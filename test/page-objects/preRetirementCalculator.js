...
class PreRetirementCalculator extends Page {
     ...
     *
     */
    async doCalculate_001(currentAge, retirementAge, currentAnnualIncome, spouseAnnualIncome, currentRetirementSavingsBalance, currentlySavingEachYearForRetirement, rateOfIncreaseYourSavingsEachYear, 
    //Optional parameters
    socialSecurityBenefitsRadioButtonYes = "No", maritalStatusMarriedRadioButton = "Single", socialSecurityOverrideAmount = "0") {
    ...
    async enterDefaultValues_001(otherIncomeDuringRetirement, yearsDependOnRetirementIncome, preRetirementInvestmentReturn, postRetirementInvestmentReturn, expectedAnnualIncomeInRetirement, 
    //Optional parameters
    //Toggle to Yes or No
    postRetirementIncomeAdjustToInflationRadioButtonToggle = "No", 
    //Set to Zero for default
    expectedInflationRate = "10") {
